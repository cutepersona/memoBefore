...
public class SenSorScroll implements SensorEventListener {
    private static final float THRESHOLD_MOTION = 0.001f;
    private static final int SENSOR_DELAY_MICROS = 32 * 1000; // 32ms                   // 센서 스크롤 체크
     ...
     */
    public SenSorScroll(Context ctx, ScrollListener scrollListener) {
