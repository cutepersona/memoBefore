...
import com.peng.power.memo.databinding.DialogVideoFileSaveBinding
...
class VideoFileSaveDialog(context: Context): Dialog(context, R.style.DialogCustomTheme) {
    ...
    init {
        ...
        if (display?.widthPixels == 1280 && display?.heightPixels == 720) {
            ...
            binding.tvSave.setTextSize(fontSize)
            binding.tvPastTime.setTextSize(26f)
            binding.tvTotalTime.setTextSize(26f)
        }
